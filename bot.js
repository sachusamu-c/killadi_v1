...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp... Please wait.')}`);
    ...
    conn.on('open', async () => {
        ...
        console.log(
            chalk.green.bold('𝐊𝐈𝐋𝐋𝐀𝐃𝐈 Running! 🦋🍃')
        );
    });
...
*/
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*~🦋🕊️______ 𝐊𝐈𝐋𝐋𝐀𝐃𝐈 𝐁𝐎𝐓 _____🕊️🦋~*' +
                                    '\n\n*🧞‍♂️ ' + error + '*\n\n Max Error oyvakkan Subscribe cheyyu https://youtube.com/channel/UCcK1W-UiDJWd_Az00aPfKCw'
                                    , MessageType.text);
                            }
                            if (error.message.includes('URL')) {
                                    return await WhatsAsenaCN.sendMessage(WhatsAsenaCN.user.jid, '*⚕️ HATA ÇÖZÜMLEME [🦋🕊️______ 𝐊𝐈𝐋𝐋𝐀𝐃𝐈 𝐁𝐎𝐓 _____🕊️🦋] ⚕️*' + 
                                        '\n========== ```Hata Okundu!``` ==========' +
                                        '*\n\n Max Error oyvakkan Subscribe cheyyu https://youtube.com/channel/UCcK1W-UiDJWd_Az00aPfKCw' +
                                    ...
                                    return await WhatsAsenaCN.sendMessage(WhatsAsenaCN.user.jid, '*⚕️ ERROR ANALYSIS [🦋🕊️______ 𝐊𝐈𝐋𝐋𝐀𝐃𝐈 𝐁𝐎𝐓 _____🕊️🦋] ⚕️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
                                        '*\n\n Max Error oyvakkan Subscribe cheyyu https://youtube.com/channel/UCcK1W-UiDJWd_Az00aPfKCw' +
