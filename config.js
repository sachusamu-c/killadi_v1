...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By killadi' : process.env.ALL_CAPTION,
    ...
    SAID: process.env.BGM_DURATION === undefined ? '31996900' : process.env.BGM_DURATION,
    FULLEVA: process.env.FULL_EVA === undefined ? 'false' : process.env.FULL_EVA,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? '𝐊𝐈𝐋𝐋𝐀𝐃𝐈 𝐁𝐎𝐓' : process.env.BOT_NAME,
    ...
    SLINK: process.env.SOCIAL_MEDIA === undefined ? 'https://www.instagram.com/sachu_samu_creation/' : process.env.SOCIAL_MEDIA,
